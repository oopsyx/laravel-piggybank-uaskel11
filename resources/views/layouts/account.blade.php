    ...
    <div class="main-wrapper main-wrapper-1">
        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                <div class="sidebar-brand">
                    <a href="index.html"><i class="fas fa-gem" style="font-size: 18px"></i> <span style="font-size: 17px;"> PIGGY BANK </span><span style="font-size: 10px;"></span></a>
                </div>
        ...
        <footer class="main-footer" style="border-top: 3px solid #6777ef;background-color: #ffffff;margin-bottom: -20px">
            <div class="footer-left">
                © <strong>PIGGY BANK</strong> 2023. Nailah Nadya Naufal Alma.
            </div>
